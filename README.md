## Проект Sports-slides - это интересный слайдер изображений для галереи спортивного сайта.

Проект Sports-slides представляет из себя красивый слайдер, который подойдёт практически для любого сайта.

Функционалом предусмотрено перелистывание слайдов, как по нажатию на кнопки со стрелочками интерфейса сайта, так и по нажатию на кпопки стрелок на клавиатуре.<br>
В мобильной версии сайта также предусмотрено пролистывание галереи по нажатию кнопки, а также реализовано перемещение свайпом по карточкам.
